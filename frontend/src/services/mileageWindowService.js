...
export const closeMileageWindow = async () => {
  const res = await adminFetch(`${API}/fenetre/fermer`, { method: "POST" });
  const data = await res.json();
